export const ITEMS = {
  wood: {
    name: 'Wood',
    type: 'resource',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/rotten_log.png',
    useImageTag: true,
    stackable: true,
  ...
  copper: {
    name: 'Copper Ore',
    type: 'resource',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/copper_ore.png',
    useImageTag: true,
    stackable: true,
  ...
  bronze_bar: {
    name: 'Bronze Bar',
    type: 'material',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/bronze_bar.png',
    useImageTag: true,
    stackable: true,
  ...
  cloth_chest: {
    name: 'Cloth Chest',
    type: 'armor',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/cloth_chest.png',
    useImageTag: true,
    stackable: false,
  ...
  pine_log: {
    name: 'Pine Log',
    type: 'resource',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/pine_log.png',
    useImageTag: true,
    stackable: true,
  ...
  fir_log: {
    name: 'Fir Log',
    type: 'resource',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/fir_log.png',
    useImageTag: true,
    stackable: true,
  ...
  maple_log: {
    name: 'Maple Log',
    type: 'resource',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/maple_log.png',
    useImageTag: true,
    stackable: true,
  ...
  birch_log: {
    name: 'Birch Log',
    type: 'resource',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/birch_log.png',
    useImageTag: true,
    stackable: true,
  ...
  copper_bar: {
    name: 'Copper Bar',
    type: 'material',
    icon: 'https://file.garden/Zy7B0LkdIVpGyzA1/LTTD-Assets/copper_bar.png',
    useImageTag: true,
    stackable: true,
